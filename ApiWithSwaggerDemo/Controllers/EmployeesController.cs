...
namespace ApiWithSwaggerDemo.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(Hexa_webapi_Core_DBContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        [Route("Employees/Gender/{Gender}/Salary/{Salary}")]

       // [HttpGet("{id}")]
        public async Task<ActionResult<List<Employees>>> GetEmployeesByGenderandSalary(string Gender, int Salary)
        {
            var employees = await _context.Employees.Where(e => e.Gender == Gender && e.Salary == Salary).ToListAsync();
